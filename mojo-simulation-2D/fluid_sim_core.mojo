...
struct SimConfig:
    ...
    fn __init__(out self):
        ...
        self.obstacle_size = SIMD[DType.float64, 2](2.0, 0.6)
        self.obstacle_centre = SIMD[DType.float64, 2](0.0, -0.8)
...
struct FluidSim2D:
    ...
    fn __init__(out self, var cfg: SimConfig):
        ...
        self.positions = List[SIMD[DType.float64, 2]]()
        self.predicted_positions = List[SIMD[DType.float64, 2]]()
        self.velocities = List[SIMD[DType.float64, 2]]()
    ...
    fn _update_densities(mut self):
        ...
        for i in range(self.particle_count):
            ...
            # Simple brute force neighbor search (no spatial hashing for simplicity)
    ...
    fn _apply_viscosity(mut self, dt: Float64):
        ...
        var delta_v = List[SIMD[DType.float64, 2]]()
    ...
    fn step(mut self, frame_time: Float64):
        ...
        for _ in range(self.iterations_per_frame):
            ...
            # densities (brute force, no spatial hash)
...
fn main() raises:
    ...
    for frame in range(max_frames):
        ...
        # Output: F <frame> <collisions> <bounds_w> <bounds_h> <obstacle_x> <obstacle_y> <obstacle_w> <obstacle_h> <particle_count> x0 y0 vx0 vy0 x1 y1 vx1 vy1 ...
